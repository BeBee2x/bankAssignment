...
// from-WinHtut-to-lonelone-100
    ...
    int time_counter= charCounting(cur_time);
    ...
    if(who == 't'){
        ...
        db[transfer].trc[space_array[transfer]-15].note[index_point]=45;
        index_point+=1;
        ...
        for (int i = 0; i < time_counter; i++) {
            db[transfer].trc[space_array[transfer]-15].note[index_point]=cur_time[i];
            index_point++;
        }
        ...
        db[receiver].trc[space_array[receiver]-15].note[index_point]=45;
        index_point+=1;
        ...
        for (int i = 0; i < time_counter; i++) {
            db[receiver].trc[space_array[receiver]-15].note[index_point]=cur_time[i];
            index_point++;
        }
